...
export function useUpdateUserAuthModuleMutation(
  options?: Omit<
    UseMutationOptions<
      UpdateUserAuthModuleMutationResult,
      Error,
      UpdateUserAuthModuleMutationVariables
    >,
    'mutationFn'
  >
) {
  ...
  return useMutation({
    mutationFn: (variables: UpdateUserAuthModuleMutationVariables) =>
      execute<
        UpdateUserAuthModuleMutationResult,
        UpdateUserAuthModuleMutationVariables
      >(updateUserAuthModuleMutationDocument, variables),
